...
public class DataInitializer {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Category catLampen = ensureCategory(categoryRepository, "Lampen");
            Category catLichtpanelen = ensureCategory(categoryRepository, "Lichtpanelen");
            Category catPodium = ensureCategory(categoryRepository, "Podiumelementen");
            Category catKabels = ensureCategory(categoryRepository, "Kabels & adapters");
            Category catAudio = ensureCategory(categoryRepository, "Audio");
            Category catStroom = ensureCategory(categoryRepository, "Stroom & verdelers");
            Category catStatieven = ensureCategory(categoryRepository, "Statieven & bevestiging");
    ...
    private Category ensureCategory(CategoryRepository categoryRepository, String name) {
